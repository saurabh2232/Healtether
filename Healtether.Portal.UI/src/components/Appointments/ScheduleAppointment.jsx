        ...
        <div className="py-6">
            ...
            <div className="flex flex-wrap py-4">
                ...
                <div className="w-1/3 pr-2">
                    <TEInput type="tel" id="Mobile" label="Mobile" size="lg" theme={inputTextLeadSize}></TEInput>
                </div>
                <div className="w-1/3 pr-2">
                    <TEInput type="text" id="Name" label="Name" size="lg" theme={inputTextLeadSize}></TEInput>
                </div>
                <div className="w-1/3 pr-2">
                    <CustomSelect
                        placeholdertext="Select Gender"
                        options={genderOption}
                        customclass={inputTextLeadSize}/>
                </div>

                <div className="w-1/3 mt-4 pr-2">
                    <DateSelect placeholdertext="Select a BirthDate" selectclassname={inputPickerLgClass}/>

                </div>
                <div className="w-24 mt-4 pr-2">
                    <TEInput type="text" id="Age" label="Age" size="lg" theme={inputTextLeadSize}></TEInput>
                </div>
            ...
            <div className="py-6">
                ...
                <div className="flex flex-wrap py-4">
                    <div className="w-1/3 pr-2">
                        <DateSelect placeholdertext="Select Appoinment Date" selectclassname={inputPickerLgClass}/>
                    </div>
                    <div className="w-1/3 pr-2">
                        <TimeSelect placeholdertext="Select Appoinment Time" selectclassname={inputPickerLgClass}/>
                    </div>
                    <div className="w-1/3 pr-2">
                        <CustomSelect
                    ...
                    <TEInput type="text" id="Reason" label="Appointment Reason" size="lg" theme={inputTextLeadSize}></TEInput>
                    </div>
                </div>
